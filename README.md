# Book Bot
<p>Made by Anna Patillo</p>
<p>"The Library of all Libraries"</p>
<p>As a reader, I want to search book summaries so I can get my next read.</p>
...
will go here
```
<p>explanation goes here (what triggers, what changes, what data flows)</p>
